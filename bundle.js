        ...
        function _s(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            Ti === e &&
              (Mi & t) === t &&
              (4 === Ii ||
              (3 === Ii && (130023424 & Mi) === Mi && 500 > Ge() - Vi)
                ? ps(e, 0)
                : (Ai |= t)),
            ls(e, n);
        }
    ...
    (() => {
        ...
        return (
          (0, e.useEffect)(
            function () {
              ...
              return function () {
                clearTimeout(e), console.log("UseEffect return");
              };
            },
            [u]
          ),
      ...
      function u(n) {
        ...
        return (
          (0, e.useEffect)(
            function () {
              "" !== r
                ? fetch("https://dummyjson.com/products/search?q=" + r.trim())
                    .then(function (e) {
                      return e.json();
                    })
                    .then(function (e) {
                ...
                : fetch("https://dummyjson.com/products?limit=10&skip=" + l)
                    .then(function (e) {
                      return e.json();
                    })
                    .then(function (e) {
      ...
      function s(n) {
        ...
        return e.createElement(
          ...
          e.createElement("input", { type: "text", disabled: !0, value: u }),
          e.createElement(
            "button",
            {
              onClick: function () {
      ...
      const d = function () {
        ...
        return e.createElement(
          e.Fragment,
          null,
          e.createElement("h1", null, "Search Products"),
          e.createElement(l, { searchText: t, setSearchText: r }),
          e.createElement(s, { page: o, setPage: i }),
          e.createElement(u, { searchText: t, page: o })
        );
      };
      var p = t(379),
        m = t.n(p),
